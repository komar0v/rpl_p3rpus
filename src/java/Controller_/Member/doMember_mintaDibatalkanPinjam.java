 ...
 * @author ASUS
 */
@WebServlet(name = "doMember_mintaDibatalkanPinjam", urlPatterns = {"/member/doMember_mintaDibatalkanPinjam"})
public class doMember_mintaDibatalkanPinjam extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (cookieemailnyaMember != null) {
            ...
            daoPinjem.member_mengajukanPembatalan(idPinjam_int);

            session.setAttribute("flashMessageMember", "toastr.success(\"Menunggu persetujuan Admin\",\"Permintaan batal dikirim!\",{showMethod:\"slideDown\",hideMethod:\"slideUp\",timeOut:3000});");
            response.sendRedirect(request.getContextPath() + "/member/batalPinjam");
        } else {
