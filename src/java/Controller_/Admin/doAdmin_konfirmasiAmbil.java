 ...
 * @author ASUS
 */
@WebServlet(name = "doAdmin_konfirmasiAmbil", urlPatterns = {"/admin/doAdmin_konfirmasiAmbil"})
public class doAdmin_konfirmasiAmbil extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (user_Admin != null) {
            ...
            daoPeminjaman.admin_konfirmasiAmbil_SUDAH_DIAMBIL(Integer.parseInt(idPinjam_));
