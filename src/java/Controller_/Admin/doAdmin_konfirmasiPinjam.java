 ...
 * @author ASUS
 */
@WebServlet(name = "doAdmin_konfirmasiPinjam", urlPatterns = {"/admin/doAdmin_konfirmasiPinjam"})
public class doAdmin_konfirmasiPinjam extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (user_Admin != null) {
            ...
            response.sendRedirect(request.getContextPath() + "/admin/confirmPinjam");
        } else {
