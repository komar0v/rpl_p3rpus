 ...
 * @author ASUS
 */
@WebServlet(name = "doAdmin_konfirmasiBatalAmbil", urlPatterns = {"/admin/doAdmin_konfirmasiBatalAmbil"})
public class doAdmin_konfirmasiBatalAmbil extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (user_Admin != null) {
            ...
            daoPeminjaman.admin_konfirmasiAmbil_BATAL_DIAMBIL(Integer.parseInt(idPinjam_));

            HttpSession session = request.getSession(true);

            session.setAttribute("flashMessageAdmin", "Toast.fire({icon: \"success\",title: \" Dikonfirmasi \"});");
            response.sendRedirect(request.getContextPath() + "/admin/confirmAmbil");
        } else {
