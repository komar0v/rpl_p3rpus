 ...
 * @author ASUS
 */
@WebServlet(name = "doAdmin_deleteBuku", urlPatterns = {"/admin/doAdmin_deleteBuku"})
public class doAdmin_deleteBuku extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (user_Admin != null) {
            ...
            daoBuku.deleteBuku(idBuku);

            HttpSession session = request.getSession(true);

            session.setAttribute("flashMessageAdmin", "Toast.fire({icon: \"success\",title: \" Buku berhasil dihapus \"});");
