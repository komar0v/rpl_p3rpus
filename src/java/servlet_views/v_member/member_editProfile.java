 ...
 * @author ASUS
 */
@WebServlet(name = "member_editProfile", urlPatterns = {"/member/editProfile"})
public class member_editProfile extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (emailnyaMember!=null) {
            ...
            RequestDispatcher rd = getServletContext().getRequestDispatcher("/Views_/Panel_Member/screen_editProfile_member.jsp");
