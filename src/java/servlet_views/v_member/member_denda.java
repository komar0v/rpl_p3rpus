 ...
 * @author ASUS
 */
@WebServlet(name = "member_denda", urlPatterns = {"/member/denda"})
public class member_denda extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (emailnyaMember != null) {
            request.setAttribute("denda_member", x_Peminjaman.getDendaMember(Integer.parseInt(idMember)));

            RequestDispatcher rd = getServletContext().getRequestDispatcher("/Views_/Panel_Member/screen_lihatDenda_member.jsp");
