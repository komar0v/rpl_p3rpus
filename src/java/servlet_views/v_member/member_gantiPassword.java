 ...
 * @author ASUS
 */
@WebServlet(name = "member_gantiPassword", urlPatterns = {"/member/gantiPassword"})
public class member_gantiPassword extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (emailnyaMember!=null) {
            request.setAttribute("detailMembernya", x_Member.getProfileDetails(Integer.parseInt(idMember)));
            
            RequestDispatcher rd = getServletContext().getRequestDispatcher("/Views_/Panel_Member/screen_gantiPassword_member.jsp");
