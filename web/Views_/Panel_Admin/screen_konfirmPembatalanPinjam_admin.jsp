...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Permintaan Pembatalan Pinjam</h1>
                </div>
                <div class="col-sm-6">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <table id="dataTable_" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    <% ArrayList<M_pinjamBuku> listPermintaanPinjam = (ArrayList<M_pinjamBuku>) request.getAttribute("list_semuaPermintaanPembatalanPinjam");
